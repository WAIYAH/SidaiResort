...
with open("d:/MY PROJECTS/6. Financial & Business Systems/sidai-safari-dreams/public/about.php", "r", encoding="utf-8") as f:
    content = f.read()

# Replace Page Title, Description, Image
content = re.sub(r"\$pageTitle = '.*?';", "$pageTitle = 'About Sidai Resort — Excellence in the Loita Hills | Narok Kenya';", content)
...
with open("d:/MY PROJECTS/6. Financial & Business Systems/sidai-safari-dreams/public/about.php", "w", encoding="utf-8") as f:
    f.write(content)
